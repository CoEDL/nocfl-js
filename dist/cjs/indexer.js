...
var orderBy = lodash_1.default.orderBy, uniqBy = lodash_1.default.uniqBy;
    ...
    Indexer.prototype.createIndices = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        walker = new walker_js_1.Walker({ credentials: this.credentials, domain: domain });
                        indices = {};
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.bucket.put({
                                target: indexFile,
                                json: orderBy(indices[domain_1][className][idPrefix], "id"),
                            })];
                    case 5:
                        _h.sent();
                        _h.label = 6;
