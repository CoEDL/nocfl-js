    ...
    Store.prototype.put = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            function transfer(_a) {
                var localPath = _a.localPath, json = _a.json, content = _a.content, target = _a.target, version = _a.version;
                return __awaiter(this, void 0, void 0, function () {
            ...
            function updateCrateMetadata(_a) {
                var graph = _a.graph, target = _a.target;
                return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_q) {
                switch (_q.label) {
                    ...
                    case 9:
                        crate = _q.sent();
                        if (!(target && registerFile)) return [3 /*break*/, 11];
                        _j = crate;
                        _k = "@graph";
                    ...
                    case 12:
                        ...
                        registerFile_1 = registerFile_1 !== undefined ? registerFile_1 : true;
                        if (!registerFile_1) return [3 /*break*/, 14];
                        _o = crate;
                        _p = "@graph";
                        return [4 /*yield*/, updateCrateMetadata({
                                graph: crate["@graph"],
